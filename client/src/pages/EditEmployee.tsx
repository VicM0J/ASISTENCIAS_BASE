  ...
  useEffect(() => {
    if (employee) {
      form.reset({
        ...
        barcode: employee.barcode || employee.employeeId || "",
        isActive: employee.isActive,
      });

      // Set current photo
      if (employee.photo) {
        const photoUrl = createImageUrl(new Uint8Array(employee.photo.data));
                    ...
                    <Label htmlFor="photo-upload" className="cursor-pointer">
                      ...
                      >
                        <span>
                          ...
                          {currentPhotoUrl ? "Cambiar Fotografía" : "Subir Fotografía"}
                        </span>
                      </Button>
                    </Label>
